...
## OVERVIEW
Cursor OpenAI BYOK Bridge is a small FastAPI relay that keeps `/v1/chat/completions` compatibility while translating Responses API payloads and streams. Runtime stack: FastAPI + Uvicorn + HTTPX.
